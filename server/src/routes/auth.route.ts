...
// wallet login: get a nonce, sign it, then exchange the signature for a session
router.route("/wallet/nonce").get(controller.walletNonce);
router.route("/wallet").post(controller.walletLogin);
